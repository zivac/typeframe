    ...
    static resolve(req: Request, res: Response, param?: ParamInterface): any {
        ...
        switch(param.key) {
            ...
            case ParamKey.PARAM:
                ...
                if (param.required && (paramValue === undefined || paramValue === null)) throw new HttpError(400, `${param.name} is required`);
                if (param.type) {
                    if (param.type == String && paramValue) paramValue = paramValue.toString();
